...
export const VERDICT_RULES = [
  ...
  '',
  '**Length. These are word limits, not targets. Count.**',
  '- At most 3 findings. Fewer is better; none is common. Drop the weakest before adding a fourth.',
  '- One concern per finding. Never add a second issue with "also" or a trailing clause.',
  '- Title: at most 10 words.',
  '- Body: at most 40 words. What the diff does, then what it conflicts with. No quotations',
  '  longer than a config key or identifier.',
  '- Suggested action: at most 15 words, imperative.',
  '- Source: one or two references, file:line or a decision id. No prose.',
  '- Bottom line: at most 25 words. If clean, write exactly "Ship it."',
  '',
